...
ifneq ($(filter OFFICIAL,$(EXPERIENCE_BUILD_TYPE)),)
...
# Branding
EXPERIENCE_BUILD_TYPE ?= UNOFFICIAL
...
CUSTOM_VERSION := ExperienceOS-$(EXPERIENCE_VERSION)-$(CUSTOM_BUILD)-$(CUSTOM_BUILD_DATE)-$(EXPERIENCE_BUILD_TYPE)
CUSTOM_VERSION_PROP := eleven

ADDITIONAL_BUILD_PROPERTIES += \
    org.experience.version=$(EXPERIENCE_VERSION) \
    org.pixelexperience.version=$(CUSTOM_VERSION_PROP) \
    org.pixelexperience.version.display=$(CUSTOM_VERSION) \
    org.pixelexperience.build_date=$(CUSTOM_BUILD_DATE) \
    org.pixelexperience.build_date_utc=$(CUSTOM_BUILD_DATE_UTC) \
    org.pixelexperience.build_type=$(EXPERIENCE_BUILD_TYPE)
